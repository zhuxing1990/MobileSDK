...
import com.vunke.sharehome2.Call.CallAudio_Activity;
import com.vunke.sharehome2.Call.CallVideo_Activity;
...
@SuppressLint("NewApi") 
public class CallStatusChangedReceive extends BroadcastReceiver {
	/**
	...
	private void sendSms(Context context) {
		...
		try {
			...
			String getUserName = UiUtils.GetUserName(context);
