...
public final class Config {
	 ...
	 * 广播IntentFilter 新的朋友
	 */
	public static final String NEW_FRIENDS_STATUS_CHAGED = "com.vunke.sharehome2.Config.NEW_FRIENDS_STATUS_CHANGED";
	/**
	 * 广播IntentFilter 拨号按钮样式
	 */
	public static final String CALL_DAIL="com.vunke.sharehome2.Config.CALL_DAIL";
