...
import com.vunke.sharehome2.service.CaaSSdkService;
import com.vunke.sharehome2.service.HomeService;
import com.vunke.sharehome2.utils.UiUtils;
import com.vunke.sharehome2.utils.WorkLog;
import com.vunke.sharehome2.view.MyOnTouch;
...
//	private ContactsSqlite sqlite;
	...
	public void OnClick(View v) {
		...
		} else if (v.getId() == R.id.callvideo_callKeyboard) {
		...
		} else if (v.getId() == R.id.callvideo_handsfree) {
		...
		} else if (v.getId() == R.id.swtich_video1) {
			if (CallApi.getCameraCount() < 2) {
				return;
			}
	...
	public void HandsfreeDrawableTop(boolean b) {
		if (b) {
			drawable = getResources().getDrawable(R.mipmap.call_handsfree);
			drawable.setBounds(0, 0, drawable.getMinimumWidth(),
					drawable.getMinimumHeight());
			callvideo_handsfree
			...
			drawable = getResources().getDrawable(R.mipmap.call_handsfree2);
			drawable.setBounds(0, 0, drawable.getMinimumWidth(),
					drawable.getMinimumHeight());
			callvideo_handsfree
					.setCompoundDrawables(null, drawable, null, null);
	...
	public boolean onTouch(View v, MotionEvent event) {
		if (v.getId() == R.id.callvideo_frame) {
			isOnTouch = !isOnTouch;
			if (subscribe != null) {
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		case KeyEvent.KEYCODE_BACK:
			Builder dl = new Builder(mcontext);
			dl.setTitle("关闭视频并退出");
